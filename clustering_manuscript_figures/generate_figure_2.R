...
risk.score.centroids = do.call(rbind,lapply(1:4, function(x) {
    colMeans(table.hr[sc@.Data==x,],na.rm=T)
}))
risk.score.sds = do.call(rbind,lapply(1:4, function(x) {
    colSds(table.hr[sc@.Data==x,],na.rm=T)
}))
...
risk.score.centroids = do.call(rbind,lapply(1:4, function(x) {
    colMeans(table.lact[sc@.Data==x,],na.rm=T)
}))
risk.score.sds = do.call(rbind,lapply(1:4, function(x) {
    colSds(table.lact[sc@.Data==x,],na.rm=T)
}))
...
risk.score.centroids = do.call(rbind,lapply(1:4, function(x) {
    colMeans(table.sbp[sc@.Data==x,],na.rm=T)
}))
risk.score.sds = do.call(rbind,lapply(1:4, function(x) {
    colSds(table.sbp[sc@.Data==x,],na.rm=T)
}))
